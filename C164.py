...
btn_open=Button(root,text="Open Image",command=Open,relief="flat",font=("Times New Roman0",15),bg="#743282",fg="white")
...
label_image=Label(root,text="",bg="white",fg="white")
label_image.pack()
root.mainloop()
